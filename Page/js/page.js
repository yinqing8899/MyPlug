(function(root,factory,plug){
	...
	me.loadPageList = function(params){
		...
		liArr = li;
			switch(params.style) {
				case  1 :
				liArr.unshift('<li><a class="first-page '+firstHide+'" data-page="first-page" title="首页">首页</a></li>');
				liArr.unshift('<li><a class="prev-page '+prevHide+'" data-page="prev-page" title="上一页">上一页</a></li>')
				liArr.push('<li><a class="last-page '+lastHide+'" data-page="last-page" title="尾页">尾页</a></li>');
